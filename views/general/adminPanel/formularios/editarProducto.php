...
<div class="editContanier">
	...
	<form class='admin-panel-form'
		action="index.php?controller=Producto&action=botonEditarProducto&id_producto=<?php echo $info[0]['id_producto']; ?>"
		...
		<div class="formgroup">
			<div class="destgroup">
				...
				<div class="formgroup">
					<input type="checkbox" id="" name="destacado" <?php if ($info[0]['destacado'])
						echo 'checked'; ?>>
			...
			<div class="formgroup">
				...
				<select id="categoria" name="categoria" style="width: 40%; margin: auto;">
					<?php
			...
			<div class="estadoGrorup">
				...
				<input type="checkbox" id='checkestado' name="estado" <?php if ($info[0]['estado'])
					echo 'checked'; ?>>
			</div>
		...
		<br><br>
		<a role='link' href="index.php?controller=Admin&action=botonVistaProducto"
			class='admin-panel-submit-link'>Volver atras</a>
